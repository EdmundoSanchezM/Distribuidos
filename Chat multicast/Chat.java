...
class Chat {
        ...
        public void run() {
            ...
            try {
                while (true) {
                    ...
                    System.out.println(new String(mensaje,"IBM437"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        Scanner scanner = new Scanner(System.in,"IBM437");
        while (true) {
            System.out.println("Ingrese el mensaje a enviar: ");
            String mensaje = scanner.nextLine();
            String salida = nombre + ":" + mensaje;
            //BigInteger bigInteger = new BigInteger(1, mensaje.getBytes("IBM437"));
            //String mensajeHex = String.format("%x", bigInteger);
            //System.out.println("String en Hex: " + mensajeHex);
            envia_mensaje_multicast(salida.getBytes("IBM437"), "230.0.0.0", 10000);
        }
    }
}
